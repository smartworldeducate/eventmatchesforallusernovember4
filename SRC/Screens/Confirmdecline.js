...
// console.log("resquest===",selectedVlueMyRequest);
          ...
          <View style={{flex: 0.33, flexDirection: 'row'}}>
            ...
            <View
              ...
              <Text
                ...
                ellipsizeMode="tail"
                numberOfLines={3}>
                {item?.last_name} {item?.match_status === '1' && item?.mine_request==='1' &&('is yet to confirm/decline the meeting request')}{item?.match_status === '2' && item?.mine_request==='1' &&('has confirmed your meeting request')}{item?.match_status === '3' && item?.mine_request==='1' &&('is yet to decline the meeting request')}{item?.match_status === '2' && item?.mine_request==='0' &&('is yet to confirm/decline the meeting request')}{item?.match_status === '1' && item?.mine_request==='0' &&('is yet to confirm/decline the meeting request')} 
          ...
          <View
            ...
            <View
              style={{
                ...
                {/* <TouchableOpacity
                  onPress={() => bookUserMeetingHandler(item?.user_id)}
                  style={{
                    flex: 0.5,
                    justifyContent: 'center',
                    alignItems: 'center',
              ...
              {/* {item?.match_status === '2' && (
                <TouchableOpacity
                  onPress={() => bookUserMeetingHandler(item?.userId)}
                  style={{
                    flex: 0.5,
                    justifyContent: 'center',
                    alignItems: 'center',
  ...
  return (
    ...
    >
      ...
      >
        <Text
          style={{
            ...
            fontSize: hp(3),
            fontFamily: 'Roboto-Medium', // fontFamily.robotoMedium
            fontWeight: '400',
          }}
        >
          Meeting Requests
      ...
      {['ALL', 'Pending', 'Confirmed', 'Declined', 'My Requests'].map((option, index) => (
        <View style={{ flex: 0.1, flexDirection: 'row', marginTop: index === 0 ? hp(2) : hp(3) }} key={option}>
