...
// const itemData =speakerDetailData?.user?.response?.events[0];
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={{flex: 0.45, marginHorizontal: hp(2.5),justifyContent:'center',alignItems:'center',marginLeft:hp(5)}}>
        {abstract && ( <ScrollView>
         <RenderHtml
                  contentWidth={400}
                  source={{
...
{booth && (<View style={{justifyContent:'center',alignItems:'center'}}>
  <TouchableOpacity
