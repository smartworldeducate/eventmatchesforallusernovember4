                ...
                <TouchableOpacity
                  ...
                  <View style={{marginHorizontal: hp(1.5), marginTop: hp(-2)}}>
                    <Text
                      ...
                      numberOfLines={4}
                      ellipsizeMode={'tail'}>
                      React Native is an open-source UI software framework created by Meta Platforms about Inc. It is used to develop applications for Android, Android TV, iOS, macOS, tvOS, Web, Windows and UWP by enabling developers to use the React framework along with native platform capabilities.
                    </Text>
                  </View>
                </TouchableOpacity>
              );
