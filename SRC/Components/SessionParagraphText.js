  ...
  return (
    ...
    <View style={{flex:0.25,marginTop:hp(1),justifyContent:'center'}}>
        <View style={{flexDirection:'row',flex:0.44}}>
            ...
            <Icon type="light" name="calendar-days" size={hp(3.5)} color="#2CC2E4" />
            </View>
        ...
        <View style={{flexDirection:'row',flex:0.44,marginTop:hp(1.5)}}>
            <View style={{flex:0.15,backgroundColor:'#cdcdcd',borderRadius:hp(50),justifyContent:"center",alignItems:'center'}}>
            <Icon type="light" name="location-dot" size={hp(3.5)} color="#2CC2E4" />
            </View>
            <View style={{flex:0.04}}></View>
            <View style={{flex:0.75}}>
      ...
      <TouchableOpacity  style={{flex:0.37,borderRadius:hp(5),borderWidth:2,borderColor:'#2CC2E4',height:hp(6),justifyContent:'center',alignItems:'center',backgroundColor:'#2CC2E4'}}>
      ...
      <TouchableOpacity  onPress={()=>{}}style={{flex:0.37,borderRadius:hp(5),borderWidth:2,borderColor:'#2CC2E4',height:hp(6),justifyContent:'center',alignItems:'center',marginHorizontal:hp(1)}}>
      <Text style={{color:'#2CC2E4',fontSize:hp(2),fontWeight:'600'}}>Speakers</Text>
        {/* <Text style={{color:'#2CC2E4',fontSize:hp(1.3),fontWeight:'300'}}>8th, Nov 2022</Text> */}
      </TouchableOpacity>
      <TouchableOpacity style={{flex:0.37,borderRadius:hp(5),borderWidth:2,borderColor:'#2CC2E4',height:hp(6),justifyContent:'center',alignItems:'center'}}>
      <Text style={{color:'#2CC2E4',fontSize:hp(2),fontWeight:'600'}}>Resources</Text>
        {/* <Text style={{color:'#2CC2E4',fontSize:hp(1.3),fontWeight:'300'}}>8th, Nov 2022</Text> */}
      </TouchableOpacity>
      </View>
